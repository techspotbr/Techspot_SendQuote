...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    public function getEmailUrl()
    {
        return $this->getUrl(
            'sendquote/*/email',
            ['order_id' => $this->getSendquote()->getOrder()->getId(), 'sendquote_id' => $this->getSendquote()->getSendquoteId()]
        );
    }
    ...
    {
        return $this->getUrl('sendquote/*/edit', ['sendquote_id' => $this->getSendquote()->getSendquoteId()]);
    }
