 ...
 * @since 100.0.2
 */
class Requesting extends \Magento\Framework\View\Element\Template
{
    /**
     * Entered Data cache
     *
    ...
    {
        $this->pageConfig->getTitle()->set(__('Request Quotation'));
    }
    ...
    public function getEnteredData($key)
    {
        if ($this->_enteredData === null) {
            $this->_enteredData = $this->_sendquoteSession->getData('requesting_form', true);
        }
    ...
    /**
     * Retrieve number of emails allowed for request
     *
     * @return int
     */
