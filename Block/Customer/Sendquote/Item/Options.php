 ...
 *
 * @api
 * @method \Techspot\SendQuote\Model\Item getItem()
 * @since 100.0.2
 */
class Options extends \Techspot\SendQuote\Block\AbstractBlock
{
    /**
    ...
    protected $_optionsCfg = [
        'default' => [
            ...
            'template' => 'Techspot_SendQuote::options_list.phtml',
        ],
    ];
