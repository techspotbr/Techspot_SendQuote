...
use Techspot\SendQuote\Model\Item\Option;
use Techspot\SendQuote\Model\Item\OptionFactory;
use Techspot\SendQuote\Model\ResourceModel\Item\Option\CollectionFactory;
use Magento\Catalog\Model\Product\Exception as ProductException;

/**
 * Sendquote item model
 *
 * @method int getSendquoteId()
 * @method \Techspot\SendQuote\Model\Item setSendquoteId(int $value)
 * @method int getProductId()
 * @method \Techspot\SendQuote\Model\Item setProductId(int $value)
 * @method int getStoreId()
 * @method \Techspot\SendQuote\Model\Item setStoreId(int $value)
 * @method string getAddedAt()
 * @method \Techspot\SendQuote\Model\Item setAddedAt(string $value)
 * @method string getDescription()
 * @method \Techspot\SendQuote\Model\Item setDescription(string $value)
...
class Item extends AbstractModel implements ItemInterface
{
     ...
     * @var string
     */
    protected $_customOptionDownloadUrl = 'sendquote/index/downloadCustomOption';
     ...
     * @var string
     */
    protected $_eventPrefix = 'sendquote_item';
     ...
     * @var OptionFactory
     */
    protected $_sendquoteOptFactory;

    /**
     * @var CollectionFactory
     */
    protected $_sendqOptionCollectionFactory;
     ...
     * @param OptionFactory $sendquoteOptFactory
     * @param CollectionFactory $sendqOptionCollectionFactory
    ...
    public function __construct(
        ...
        OptionFactory $sendquoteOptFactory,
        CollectionFactory $sendqOptionCollectionFactory,
        ...
        $this->_sendquoteOptFactory = $sendquoteOptFactory;
        $this->_sendqOptionCollectionFactory = $sendqOptionCollectionFactory;
    ...
    {
        $this->_init(\Techspot\SendQuote\Model\ResourceModel\Item::class);
    }
    ...
    /**
     * Set price. If price is less than 0 - set it to 1
     *
     * @param int $price
     * @return $this
     */
    ...
    {
        $this->setData('price', $price >= 0 ? $price : 1);
        return $this;
    }

    /**
     * Set custom_price. If custom price is less than 0 - set it to 1
     *
     * @param int $price
     * @return $this
     */
    ...
    {
        $this->setData('custom_price', $customPrice >= 0 ? $customPrice : 1);
        return $this;
    }
    ...
    {
        if (!$this->getSendquoteId()) {
            throw new \Magento\Framework\Exception\LocalizedException(__('We can\'t specify a quote list.'));
        }
    ...
    /**
     * Load item by product, sendquote and shared stores
     *
     ...
     * @return $this
     */
    public function loadByProductSendquote($sendquoteId, $productId, $sharedStores)
    {
        $this->_getResource()->loadByProductSendquote($this, $sendquoteId, $productId, $sharedStores);
        $this->_afterLoad();
        $this->setOrigData();
    ...
    public function addToCart(\Magento\Checkout\Model\Cart $cart, $delete = false)
    {
        ...
        $product->setCustomPrice(10.99);
        $product->setOriginalCustomPrice(10.99);
        */
    ...
    public function getBuyRequest()
    {
        ...
        $buyRequest->setPrice('10.99');
        $buyRequest->setSendquoteItemId($this->getSendquoteItemId());
    ...
    {
        if (is_array($option)) {
            $option = $this->_sendquoteOptFactory->create()->setData($option)->setItem($this);
        } elseif ($option instanceof Option) {
            $option->setItem($this);
        } elseif ($option instanceof \Magento\Framework\DataObject) {
            $option = $this->_sendquoteOptFactory->create()->setData($option->getData())
    ...
    public function loadWithOptions($id, $optionsFilter = null)
    {
        ...
        $options = $this->_sendqOptionCollectionFactory->create()->addItemFilter($this);
        if ($optionsFilter) {
