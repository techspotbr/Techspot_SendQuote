...
/**
 * Sendquote item option collection
 *
 * @author      Magento Core Team <core@magentocommerce.com>
 */
namespace Techspot\SendQuote\Model\ResourceModel\Item\Option;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            \Techspot\SendQuote\Model\Item\Option::class,
            \Techspot\SendQuote\Model\ResourceModel\Item\Option::class
        );
    }
    ...
    protected function _afterLoad()
    {
        ...
        foreach ($this as $option) {
            ...
            $itemId = $option->getSendquoteItemId();
    ...
    public function addItemFilter($item)
    {
        if (empty($item)) {
            ...
            $this->addFieldToFilter('sendquote_item_id', ['in' => $item]);
        } elseif ($item instanceof Item) {
            $this->addFieldToFilter('sendquote_item_id', $item->getId());
        } else {
            $this->addFieldToFilter('sendquote_item_id', $item);
        }
