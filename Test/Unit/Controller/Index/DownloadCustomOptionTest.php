...
{
    /**
     * @var \Techspot\SendQuote\Controller\Index\DownloadCustomOption
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->model = new \Techspot\SendQuote\Controller\Index\DownloadCustomOption(
            $this->contextMock,
    ...
    public function testExecute()
    {
        ...
        $this->objectManagerMock->expects($this->any())
            ...
            ->willReturnMap(
                [
                    [\Techspot\SendQuote\Model\Item\Option::class, [], $optionMock],
