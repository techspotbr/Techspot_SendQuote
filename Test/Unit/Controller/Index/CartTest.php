...
use Techspot\SendQuote\Controller\Index\Cart;
...
class CartTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->sendquoteProviderMock = $this->getMockBuilder(
            \Techspot\SendQuote\Controller\SendquoteProviderInterface::class
        )->disableOriginalConstructor()
            ->setMethods(['getSendquote'])
        ...
        $this->itemFactoryMock = $this->getMockBuilder(\Techspot\SendQuote\Model\ItemFactory::class)
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        ...
        $this->optionFactoryMock = $this->getMockBuilder(\Techspot\SendQuote\Model\Item\OptionFactory::class)
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        ...
        $this->helperMock = $this->getMockBuilder(\Techspot\SendQuote\Helper\Data::class)
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testExecuteWithNoSendquote()
    {
        ...
        $itemMock = $this->getMockBuilder(\Techspot\SendQuote\Model\Item::class)
            ->disableOriginalConstructor()
            ->setMethods(['load', 'getId', 'getSendquoteId'])
            ->getMock();
    ...
    protected function prepareExecuteWithQuantityArray($isAjax = false)
    {
        ...
        $optionsMock = $this->getMockBuilder(\Techspot\SendQuote\Model\ResourceModel\Item\Option\Collection::class)
            ->disableOriginalConstructor()
            ->getMock();
