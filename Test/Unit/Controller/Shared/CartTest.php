...
use Techspot\SendQuote\Controller\Shared\Cart as SharedCart;
use Techspot\SendQuote\Model\Item;
use Techspot\SendQuote\Model\Item\Option;
use Techspot\SendQuote\Model\Item\OptionFactory;
use Techspot\SendQuote\Model\ItemFactory;
use Techspot\SendQuote\Model\ResourceModel\Item\Option\Collection as OptionCollection;
...
class CartTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->optionCollection = $this->getMockBuilder(
            \Techspot\SendQuote\Model\ResourceModel\Item\Option\Collection::class
        )->disableOriginalConstructor()->getMock();

        $this->option = $this->getMockBuilder(\Techspot\SendQuote\Model\Item\Option::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->item = $this->getMockBuilder(\Techspot\SendQuote\Model\Item::class)
            ->disableOriginalConstructor()
            ->getMock();
