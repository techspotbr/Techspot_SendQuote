 ...
 */
namespace Techspot\SendQuote\Test\Unit\Pricing\ConfiguredPrice;
...
class ConfigurableProductTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Techspot\SendQuote\Pricing\ConfiguredPrice\ConfigurableProduct
     */
    private $model;
    ...
    protected function setUp()
    {
        ...
        $this->model = new \Techspot\SendQuote\Pricing\ConfiguredPrice\ConfigurableProduct(
            $this->saleableItem,
            null,
            $this->calculator,
            $this->priceCurrency
    ...
    public function testGetValue()
    {
        ...
        $this->priceInfoMock->expects($this->once())
            ->method('getPrice')
            ->with(\Techspot\SendQuote\Pricing\ConfiguredPrice\ConfigurableProduct::PRICE_CODE)
        ...
        $sendquoteItemOptionMock = $this->getMockBuilder(\Techspot\SendQuote\Model\Item\Option::class)
            ->disableOriginalConstructor()
            ->getMock();
        $sendquoteItemOptionMock->expects($this->once())
            ->method('getProduct')
        ...
        $this->saleableItem->expects($this->once())
            ...
            ->with('simple_product')
            ->willReturn($sendquoteItemOptionMock);
