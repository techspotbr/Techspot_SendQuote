...
class ItemCarrierTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var \Techspot\SendQuote\Model\LocaleQuantityProcessor|\PHPUnit_Framework_MockObject_MockObject */
    ...
    protected function setUp()
    {
        $this->sessionMock = $this->getMockBuilder(\Magento\Customer\Model\Session::class)
            ...
            ->getMock();
        $this->quantityProcessorMock = $this->getMockBuilder(\Techspot\SendQuote\Model\LocaleQuantityProcessor::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->model = new \Techspot\SendQuote\Model\ItemCarrier(
            $this->sessionMock,
    ...
    public function testMoveAllToCart()
    {
        ...
        /** @var \Techspot\SendQuote\Model\Item|\PHPUnit_Framework_MockObject_MockObject $itemOneMock */
        $itemOneMock = $this->getMockBuilder(\Techspot\SendQuote\Model\Item::class)
            ->setMethods(['getProduct', 'unsProduct', 'getId', 'setQty', 'addToCart', 'delete', 'getProductUrl'])
            ->disableOriginalConstructor()
            ->getMock();
        /** @var \Techspot\SendQuote\Model\Item|\PHPUnit_Framework_MockObject_MockObject $itemTwoMock */
        $itemTwoMock = $this->getMockBuilder(\Techspot\SendQuote\Model\Item::class)
            ->setMethods(['getProduct', 'unsProduct', 'getId', 'setQty', 'addToCart', 'delete', 'getProductUrl'])
            ->disableOriginalConstructor()
            ->getMock();
        ...
        /** @var \Techspot\SendQuote\Model\Sendquote|\PHPUnit_Framework_MockObject_MockObject $sendquoteMock */
        ...
        $collectionMock = $this->getMockBuilder(\Techspot\SendQuote\Model\ResourceModel\Item\Collection::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->assertEquals($redirectUrl, $this->model->moveAllToCart($sendquoteMock, $qtys));
    }
    ...
    public function testMoveAllToCartWithNotSalableAndOptions()
    {
        ...
        $this->urlBuilderMock->expects($this->once())
            ->method('getUrl')
            ->with('sendquote/shared', ['code' => $sharingCode])
            ->willReturn($indexUrl);
        ...
        $this->assertEquals($indexUrl, $this->model->moveAllToCart($sendquoteMock, $qtys));
    }
    ...
    public function testMoveAllToCartWithException()
    {
        ...
        $this->managerMock->expects($this->at(1))
            ->method('addError')
            ->with(__('We can\'t update the Quotations right now.'), null)
            ->willReturnSelf();
