...
class ItemTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Techspot\SendQuote\Model\ResourceModel\Item|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $resource;

    /**
     * @var \Techspot\SendQuote\Model\ResourceModel\Item\Collection|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    /**
     * @var \Techspot\SendQuote\Model\Item\OptionFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $optionFactory;

    /**
     * @var \Techspot\SendQuote\Model\ResourceModel\Item\Option\CollectionFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->catalogUrl = $this->getMockBuilder(\Magento\Catalog\Model\ResourceModel\Url::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->optionFactory = $this->getMockBuilder(\Techspot\SendQuote\Model\Item\OptionFactory::class)
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->itemOptFactory =
            $this->getMockBuilder(\Techspot\SendQuote\Model\ResourceModel\Item\Option\CollectionFactory::class)
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        ...
        $this->resource = $this->getMockBuilder(\Techspot\SendQuote\Model\ResourceModel\Item::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->collection = $this->getMockBuilder(\Techspot\SendQuote\Model\ResourceModel\Item\Collection::class)
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testAddGetOptions($code, $option)
    {
        ...
        $optionMock = $this->getMockBuilder(\Techspot\SendQuote\Model\Item\Option::class)
            ->disableOriginalConstructor()
    ...
    {
        $this->assertEmpty($this->model->getOptions());
        $firstOptionMock = $this->getMockBuilder(\Techspot\SendQuote\Model\Item\Option::class)
            ->disableOriginalConstructor()
        ...
        $secondOptionMock = $this->getMockBuilder(\Techspot\SendQuote\Model\Item\Option::class)
            ->disableOriginalConstructor()
