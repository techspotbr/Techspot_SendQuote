...
namespace Techspot\SendQuote\Test\Unit\Model\ResourceModel\Item;
 ...
 WHERE (INSTR(product_name_table.value, 'TestProductName'))";
    ...
    protected function setUp()
    {
        ...
        $resource = $this->createPartialMock(
            \Techspot\SendQuote\Model\ResourceModel\Item::class,
        ...
        $this->collection = $this->objectManager->getObject(
            \Techspot\SendQuote\Model\ResourceModel\Item\Collection::class,
            [
                'resource' => $resource,
