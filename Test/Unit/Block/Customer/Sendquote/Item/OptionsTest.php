 ...
 */
namespace Techspot\SendQuote\Test\Unit\Block\Customer\Sendquote\Item;

use Techspot\SendQuote\Block\Customer\Sendquote\Item\Options;
...
class OptionsTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Techspot\SendQuote\Model\Item|\PHPUnit_Framework_MockObject_MockObject
     */
    private $itemMock;
    ...
    protected function setUp()
    {
        ...
        $this->itemMock = $this->getMockBuilder(\Techspot\SendQuote\Model\Item::class)
            ->disableOriginalConstructor()
            ->getMock();
